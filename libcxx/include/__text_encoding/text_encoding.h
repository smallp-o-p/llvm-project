...
_LIBCPP_BEGIN_NAMESPACE_STD
 ...
 struct text_encoding {
    ...
    LIBCPP_HIDE_FROM_ABI static constexpr __encoding_data __enc_data [] = {
      { 3, "US-ASCII" },
      { 3, "ANSI_X3.4-1968" },
      { 3, "ANSI_X3.4-1986" },
      { 3, "IBM367" },
    ...
    constexpr text_encoding(id __i) noexcept : mib_(__i), __name() {};
    
    constexpr id mib() const noexcept { return __mib; };
    constexpr const char* name() const noexcept { return __name; };
    
    // [text.encoding.aliases], class text_encoding​::​aliases_view
    struct aliases_view;
    constexpr aliases_view aliases() const noexcept;

    friend constexpr bool operator==(const text_encoding& __a,
                                     const text_encoding& __b) noexcept;
    friend constexpr bool operator==(const text_encoding& __encoding, id __i) noexcept;
  ...
  private:
    ...
    static constexpr bool comp_name(string_view __a, string_view __b);      // exposition only
 };
